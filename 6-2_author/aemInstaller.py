...
installProcess = subprocess.Popen(['java', '-Xmx1280m', '-XX:MaxPermSize=256m', '-jar', fileName, '-listener-port','50007','-r',runmode,'nosamplecontent','-p',port,'-v'])
...
if successfulStart:
  ...
  for childProcess in parentAEMprocess.children():
